...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Only owner of the contract can perform this action");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "The address requested for approval already owned the token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender ==  owner || isApprovedForAll(owner, msg.sender), "You do not have the authority to approve this token");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "This tokenId already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "The supplied from address does not own the tokenId");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function _setTokenURI(uint256 tokenId) internal {
        ...
        string memory concatenatedTokenURI = strConcat(_baseTokenURI, uint2str(tokenId));
        _tokenURIs[tokenId] = concatenatedTokenURI;
    }
...
contract CustomERC721Token is ERC721Metadata("House token", "HTKN", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
